...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:9ijn6tfc@localhost/marvel'
...
def create_database():
    root_engine = create_engine("mysql+mysqlconnector://root:9ijn6tfc@localhost")  # No database specified
